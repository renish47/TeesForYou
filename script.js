        ...
        <div class="container infoContainer ProfileContainer">
          <form id="myForm">
            ...
            <div class="address profileInfo" style="border:0 ;">
              ...
              <input type="password" class='mt-3' id="oldPass" placeholder="Old Password"><i class="oldPass showHide fa-solid fa-eye-slash" id="showHide2" onclick="showHidePassword(event)"></i><br><small id="pass2Warning" class="warning">Both passwords didn't match</small><br>
              ...
              <input type="password" class='mt-3' id="passwordSU2" placeholder="Confirm Password"><i class="passwordSU2 showHide fa-solid fa-eye-slash" id="showHide2" onclick="showHidePassword(event)"></i><br><small id="pass2Warning" class="warning">Both passwords didn't match</small><br>
...
async function loadAccountPage(event){
  ...
  </div>&ensp;&ensp;<span style="position:relative;top:-6px">Please Wait</span><br>`
                let myModal = new bootstrap.Modal(document.getElementById('myModal'), {});
                myModal.show();
